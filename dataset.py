...
class RandomRotation(object):
    ...
    def __call__(self, img, gt):
        ...
        return F.rotate(img, angle, Image.BILINEAR, self.expand, self.center), F.rotate(gt, angle, Image.NEAREST,
...
def get_loader(img_root, gt_root, img_size, batch_size, max_num=float('inf'), istrain=True, shuffle=False,
